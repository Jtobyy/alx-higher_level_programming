...
class TestRectangle(unittest.TestCase):
    ...
    def test_str_return(self):
        ...
        self.assertEqual(print(r6), '[Rectangle] (1) 0/0 - 2/2')

    def test_update_method_0(self):
        '''Test the update method as update(self, *args)'''
        r7 = Rectangle(10, 10, 10, 10, 9)
        self.assertEqual(print(r7), '[Rectangle] (9) 10/10 - 10/10')
        r7.update(89)
        self.assertEqual(print(r7), '[Rectangle] (89) 10/10 - 10/10')
        r7.update(89, 2)
        self.assertEqual(print(r7), '[Rectangle] (89) 10/10 - 2/10')
        r7.update(89, 2, 3)
        self.assertEqual(print(r7), '[Rectangle] (89) 10/10 - 2/3')
        r7.update(89, 2, 3, 4)
        self.assertEqual(print(r7), '[Rectangle] (89) 4/10 - 2/3')
        r7.update(89, 2, 3, 4, 5)
        self.assertEqual(print(r7), '[Rectangle] (89) 4/5 - 2/3')

    def test_update_method_1(self):
        '''Test the update method as update(self, *args, **kwargs)'''
        r8 = Rectangle(10, 10, 10, 10, 1)
        self.assertEqual(print(r8), '[Rectangle] (1) 10/10 - 10/10')
        r8.update(height=1)
        self.assertEqual(print(r8), '[Rectangle] (1) 10/10 - 10/1')
        r8.update(width=1, x=2)
        self.assertEqual(print(r8), '[Rectangle] (1) 2/10 - 1/1')
        r8.update(y=1, width=2, x=3, id=89)
        self.assertEqual(print(r8), '[Rectangle] (89) 3/1 - 2/1')
        r8.update(x=1, height=2, y=3, width=4)
        self.assertEqual(print(r8), '[Rectangle] (89) 1/3 - 4/2')

    def test_to_dictionary(self):
        '''test the method to_dictionary meant to return 
        the dictionary representation of a Rectangle'''
        r9 = Rectangle(10, 2, 1, 9, 1)
        self.assertEqual(print(r9), '[Rectangle] (1) 1/9 - 10/2')
        r9_dictionary = r9.to_dictionary()
        self.assertEqual(print(sorted(r9_dictionary)), '''{'height': 2, 'id': 1, 
        'x': 1, 'width': 10, 'y': 9'''}
        self.assertEqual(print(type(r9_dictionary)), "<class 'dict'>")
        r10 = Rectangle(1, 1, id=2)
        self.assertEqual(print(r10), '[Rectangle] (2) 0/0 - 1/1')
        r10.update(**r1_dictionary)
        self.assertEqual(print(r10), '[Rectangle] (1) 1/9 - 10/2')
